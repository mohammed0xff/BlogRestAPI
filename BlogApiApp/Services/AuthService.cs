...
namespace Services
{
    public class AuthService : IAuthService
    {
        ...
        public Task RevokeTokenAsync(string userId)
        {
            ...
            if (userToken != null)
            {
                _unitOfWork.TokenRepository.Remove(userToken);
                _unitOfWork.save();
            }
        ...
        private async Task<LoginModelResponse> CreateJwtToken(AppUser user)
        {
            ...
            _unitOfWork.TokenRepository.Add(refreshToken); 
            _unitOfWork.save();
        ...
        public async Task<LoginModelResponse> VerifyAndGenerateToken(TokenRequest tokenRequest)
        {
            ...
            try
            {
                ...
                var storedToken = _unitOfWork.TokenRepository.Get(x => x.Token == tokenRequest.RefreshToken);
                ...
                _unitOfWork.TokenRepository.Remove(storedToken);
                _unitOfWork.save();
